...
if __name__ == "__main__":
    path_to_files = r"/Users/student/Desktop/input/south_america-continental/"
    ...
    df = pd.read_csv(r'/Users/student/Dropbox/PhD/2019 Summer/Dissertation_v7/Colombia/Stations_Selected_Colombia.csv')
    ...
    #for spt in spt_id:
    #    output_path = "/Users/student/Desktop/output/South_America_csv/{}".format(spt)
    #    print(spt, path_to_files, output_path)
    #    extract_by_rivid(spt, path_to_files, output_path)

    for spt, comid in zip(spt_id, stations):
        if not os.path.isdir("/Users/student/Desktop/output/Colombia_csv/{}".format(spt)):
            os.makedirs("/Users/student/Desktop/output/Colombia_csv/{}".format(spt))
        output_path = "/Users/student/Desktop/output/Colombia_csv/{}".format(spt)
