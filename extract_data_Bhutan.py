...
if __name__ == "__main__":
    ...
    spt_id = df['HydroStation'].tolist()
    stations = df['comid'].tolist()

    for spt, comid in zip(spt_id, stations):
        if not os.path.isdir("/Users/student/Desktop/output/South_Asia/Bhutan/{0}-{1}".format(comid, spt)):
            os.makedirs("/Users/student/Desktop/output/South_Asia/Bhutan/{0}-{1}".format(comid, spt))
        output_path = "/Users/student/Desktop/output/South_Asia/Bhutan/{0}-{1}".format(comid,spt)
