...
for id, name, comid in zip(IDs, Names, COMIDs):
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Brazil/data/historical/Observed_Data_WL/{}.csv'.format(id))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Brazil/data/historical/Corrected_Data_WL/{0}-{1}.csv'.format(id, comid))
