...
comids = ['9123290', '9123273', '9123291']
...
fecha_ini = dt.datetime(2024,4,20)
fecha_fin = dt.datetime(2024,5,10)
fechas = pd.date_range(fecha_ini, fecha_fin, freq='D')

path_data = 'D:\\south_america'
output_path = 'D:\\Extracted_Forecast_Files\\Brazil'
