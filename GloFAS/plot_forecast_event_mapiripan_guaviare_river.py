...
fechas = ['20250610', '20250611', '20250612', '20250613', '20250614', '20250615', '20250616', '20250617', '20250618', '20250619',
          ...
          '20250710', '20250711', '20250712', '20250713', '20250714', '20250715', '20250716']
...
observed_historical = pd.read_csv("G:\\My Drive\\GEOGLOWS\\Forecast_Comparison\\Mapiripan_Flood_Event\\{0}_Q_HIS.csv".format(code), index_col=0)
...
observed_event = pd.read_csv("G:\\My Drive\\GEOGLOWS\\Forecast_Comparison\\Mapiripan_Flood_Event\\{0}_Q_RT.csv".format(code), index_col=0)
...
for fecha in fechas:
    ...
    forecast_stats_records_matplotlib(ax=axs[2], df=forecast_stats_v2, rp_df=rperiods_v2, records_df=forecast_record_plot_v2, retro_df=simulated_plot_v2, plot_titles = [f'GEOGLOWS V2 Reach ID: {comid_2}'])
    ...
    forecast_stats_records_matplotlib(ax=axs[3], df=forecast_stats_glofas_plot, rp_df=rperiods_glofas, records_df=forecast_record_plot_glofas, retro_df=simulated_plot_glofas, plot_titles=[f'GloFAS Lat-Lon: {latitude}, {longitude}'])
    plt.tight_layout(pad=0.5, h_pad=0.5)
    plt.savefig('G:\\My Drive\\GEOGLOWS\\Forecast_Comparison\\Mapiripan_Flood_Event\\Forecast_Plots\\{0}.png'.format(fecha), dpi=700)
    plt.close(fig)
