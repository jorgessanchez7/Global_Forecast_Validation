...
stations_df = pd.read_csv('Metrics_GEOGloWS_v1_sat_WL.csv')
...
#plt.savefig('/Users/grad/Library/CloudStorage/Box-Box/MSc_Darlly_Rojas/2024_Winter/Updated_Plots_v2/Metrics_GEOGLOWS_v1_bc_sat_WL.png', dpi=400, bbox_inches='tight', pad_inches=0)
plt.savefig('/Users/grad/Library/CloudStorage/Box-Box/MSc_Darlly_Rojas/2024_Winter/Updated_Plots_v2/Metrics_GEOGLOWS_v1_bc_sat_WL.pdf', format='pdf', dpi=400, bbox_inches='tight', pad_inches=0)
#plt.show()