...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	''''Using REST API'''
	era_res = requests.get('https://geoglows.ecmwf.int/api/v2/retrospective/{0}?format=csv'.format(comid), verify=False).content
	...
	simulated_df.to_csv('/Users/grad/Library/CloudStorage/Box-Box/Post_Doc/Global_Hydroserver/Simulated_Data/GEOGLOWS_v2/{}.csv'.format(comid))