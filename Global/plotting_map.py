...
plot_kge_map(axs[0], stations_v1_df, 'KGE Values - GEOGloWS v1')

# Graficar el mapa para GEOGloWS v2 en la parte inferior
plot_kge_map(axs[1], stations_v2_df, 'KGE Values - GEOGloWS v2')

# Añadir leyenda y guardar la imagen
plt.legend(title=r'$\textbf{KGE Categories}$', loc='lower left', fontsize=8)
plt.savefig('Metrics_GEOGLOWS_v1_vs_v2.png', dpi=400, pad_inches=0)
#plt.show()