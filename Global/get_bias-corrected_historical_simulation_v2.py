...
for id, name, comid, folder, source in zip(IDs, Names, COMIDs, Folders, Sources):
	...
	#Simulated Data
	simulated_df = pd.read_csv('/Users/grad/Library/CloudStorage/Box-Box/Post_Doc/Global_Hydroserver/Simulated_Data/GEOGLOWS_v2/{}.csv'.format(comid), index_col=0)
	...
	try:
		...
		corrected_df.to_csv('/Users/grad/Library/CloudStorage/Box-Box/Post_Doc/Global_Hydroserver/Corrected_Data/GEOGLOWS_v2/{0}-{1}_Q.csv'.format(id, comid))
...
for id, name, comid, folder, source in zip(IDs, Names, COMIDs, Folders, Sources):
	...
	try:
		...
		corrected_df.to_csv('/Users/grad/Library/CloudStorage/Box-Box/Post_Doc/Global_Hydroserver/Corrected_Data/GEOGLOWS_v2/{0}-{1}_WL.csv'.format(id, comid))
	except Exception as e:
		print(e)