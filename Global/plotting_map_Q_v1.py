...
#plt.savefig('Metrics_GEOGLOWS_v1_Q.png', dpi=400, bbox_inches='tight', pad_inches=0)
#plt.savefig('Metrics_GEOGLOWS_v1_Q.pdf', format='pdf', dpi=400, bbox_inches='tight', pad_inches=0)
plt.savefig('Metrics_GEOGLOWS_v1_Q_bc.png', dpi=400, bbox_inches='tight', pad_inches=0)
#plt.savefig('Metrics_GEOGLOWS_v1_Q_bc.pdf', format='pdf', dpi=400, bbox_inches='tight', pad_inches=0)
#plt.show()