...
#Get Forecast Data
#Version 1
url_1_v1 = 'https://geoglows.ecmwf.int/api/ForecastEnsembles/?reach_id={0}&return_format=csv'.format(comid_1)
...
#Version 2
url_1_v2 = 'https://geoglows.ecmwf.int/api/v2/forecastensemble/{0}'.format(comid_2)
...
forecast_record_1_v1 = forecast_record_v1.loc[forecast_record_v1.index >= pd.to_datetime(forecast_stats_1_v1.index[0] - dt.timedelta(days=10))]
forecast_record_1_v1 = forecast_record_1_v1.loc[forecast_record_1_v1.index <= pd.to_datetime(forecast_stats_1_v1.index[0])]

forecast_record_1_v2 = forecast_record_v2.loc[forecast_record_v2.index >= pd.to_datetime(forecast_stats_1_v2.index[0] - dt.timedelta(days=10))]
...
plt.savefig('G:\\My Drive\\GEOGLOWS\\Forecast_Comparison\\Plots\\Forecast Comparison {} v2.png'.format(name), dpi=700)
