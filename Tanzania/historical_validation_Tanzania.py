...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD (1)/2022_Winter/Dissertation_v13/Africa/Tanzania/Selected_Stations_Tanzania_Q_v0.csv')

IDs = stations_pd['RGS_ID'].tolist()
...
for id, name, comid in zip(IDs, Names, COMIDs):
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD (1)/2022_Winter/Dissertation_v13/Africa/Tanzania/data/historical/Observed_Data/{}.csv'.format(id))
	#simFiles.append('/Volumes/GoogleDrive/My Drive/PhD (1)/2022_Winter/Dissertation_v13/Africa/Tanzania/data/historical/Simulated_Data/{}.csv'.format(comid))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD (1)/2022_Winter/Dissertation_v13/Africa/Tanzania/data/historical/Corrected_Data/{0}-{1}.csv'.format(id, comid))


#User Input
country = 'Tanzania'
#output_dir = '/Volumes/GoogleDrive/My Drive/PhD (1)/2022_Winter/Dissertation_v13/Africa/Tanzania/data/historical/validationResults_Original/'
output_dir = '/Volumes/GoogleDrive/My Drive/PhD (1)/2022_Winter/Dissertation_v13/Africa/Tanzania/data/historical/validationResults_Corrected/'
