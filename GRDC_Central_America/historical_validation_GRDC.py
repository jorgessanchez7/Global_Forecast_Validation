...
for id, name, comid in zip(IDs, Names, COMIDs):
	comid = int(comid)
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Central_America/GRDC/data/historical/Observed_Data/{}.csv'.format(id))
	#simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Central_America/GRDC/data/historical/Simulated_Data/{}.csv'.format(comid))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Central_America/GRDC/data/historical/Corrected_Data/{0}-{1}.csv'.format(id, comid))
