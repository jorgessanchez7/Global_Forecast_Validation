...
stations_df = pd.read_csv('/Users/grad/Library/CloudStorage/Box-Box/Post_Doc/GEOGLOWS_Applications/Central_America/El_Salvador_Selected_Stations_v1.csv', index_col=2)
...
for uid in uids:
    ...
    url = "https://marn-hydroserver.geoglows.org/api/data/things/{}/ownership".format(uid)
