...
if __name__ == "__main__":
    ...
    #    if not os.path.isdir("/Users/student/Desktop/output/Africa/Ivory_Coast/{0}-{1}".format(spt, name)):
    #        os.makedirs("/Users/student/Desktop/output/Africa/Ivory_Coast/{0}-{1}".format(spt, name))
    #    output_path = "/Users/student/Desktop/output/Africa/Ivory_Coast/{0}-{1}".format(spt, name)
    #    print(comid, path_to_files, output_path)
    #    extract_by_rivid(comid, path_to_files, output_path)

    '''On Windows'''
    for name, spt, comid in zip(names, spt_id, stations):
        if not os.path.isdir("C:\\Users\\jorgessanchez7\\Desktop\output\\Africa\\Ivory_Coast\\{0}-{1}".format(spt, name)):
            os.makedirs("C:\\Users\\jorgessanchez7\\Desktop\output\\Africa\\Ivory_Coast\\{0}-{1}".format(spt, name))
        output_path = "C:\\Users\\jorgessanchez7\\Desktop\output\\Africa\\Ivory_Coast\\{0}-{1}".format(spt, name)
        print(comid, path_to_files, output_path)
        extract_by_rivid(comid, path_to_files, output_path)