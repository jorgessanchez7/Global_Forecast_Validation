...
fecha_ini = dt.datetime(2014,11,30)
fecha_fin = dt.datetime(2014,11,30)
#fecha_fin = dt.datetime(2019,12,31)
fechas = pd.date_range(fecha_ini, fecha_fin, freq='D')

#path_data = '/Volumes/GoogleDrive/My Drive/ECMWF/ECMWF_GEOGloWS_Streamflow/rapid-io/output/north_america-geoglows/'
path_data = '/Volumes/storage/ECMWF_Gridded_Runoff_Files/output_20140101-20191231/north_america-geoglows/'
output_path = '/Volumes/GoogleDrive/My Drive/Colab Notebooks/Extract_Forecast_Files/north_america'
#output_path = '/Users/ElkiGio/Desktop/north_america'
