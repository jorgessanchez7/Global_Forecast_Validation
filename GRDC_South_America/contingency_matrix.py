...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/GRDC/Selected_Stations_GRDC_Q_v0.csv')
...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	historical_df = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/GRDC/data/historical/Observed_Data/{}.csv'.format(id), index_col=0)
	...
	#simulated_df = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/GRDC/data/historical/Simulated_Data/{}.csv'.format(comid), index_col=0)

	# Bias Corrected Simulated Data
	simulated_df = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/GRDC/data/historical/Corrected_Data/{0}-{1}.csv'.format(id, comid), index_col=0)
...
#Original Simulated Data
#contingency_matrix_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/GRDC/data/historical/validationResults_Original/Tables/Contingency_Matrix_Before_Bias_Correction.csv')

#Bias Corrected Simulated Data
contingency_matrix_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/GRDC/data/historical/validationResults_Corrected/Tables/Contingency_Matrix_After_Bias_Correction.csv')
