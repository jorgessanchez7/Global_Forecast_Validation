...
for comid, name in zip(COMIDs, Names):
	...
	#simFiles.append(
	#	'/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/Africa/Blue_Nile/Data/Historical/simulated_data/ERA_Interim/Annual/'
	#	+ str(comid) + '_' + str(name) + '.csv')
	simFiles.append(
		'/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/Africa/Blue_Nile/Data/Historical/simulated_data/ERA_5/Annual/'
		+ str(comid) + '_' + str(name) + '.csv')

#User Input
catchment = 'Blue_Nile'
#output_dir = '/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/Africa/Blue_Nile/Annual/validationResults_ERA-Interim/'
output_dir = '/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/Africa/Blue_Nile/Annual/validationResults_ERA-5/'
