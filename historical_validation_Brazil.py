...
df = pd.read_csv('/Users/student/Github/Bias_Correction/Brazil/Brazil_Stations.csv')

IDs = df['CodEstacao'].tolist()
COMIDs = df['new_COMID'].tolist()
Names = df['NomeEstaca'].tolist()
Rivers = df['NomeRio'].tolist()
...
for id, comid, name in zip(IDs, COMIDs, Names):
	obsFiles.append('/Users/student/Github/Bias_Correction/Brazil/Observed/{}.csv'.format(id))
	#simFiles.append('/Users/student/Github/Bias_Correction/Brazil/Simulated/{}.csv'.format(id))
	simFiles.append('/Users/student/Github/Bias_Correction/Brazil/Corrected/{}.csv'.format(id))


#User Input
country = 'Brazil'
#output_dir = '/Users/student/Github/Bias_Correction/Brazil/validationResults_Simulated/'
output_dir = '/Users/student/Github/Bias_Correction/Brazil/validationResults_Corrected/'
