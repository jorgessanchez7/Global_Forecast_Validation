...
#Original Simulated Data
#auroc_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Central_America/Honduras/data/historical/validationResults_Original/Tables/AUROC_Before_Bias_Correction.csv')

#Bias Corrected Simulated Data
auroc_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Central_America/Honduras/data/historical/validationResults_Corrected/Tables/AUROC_After_Bias_Correction.csv')
