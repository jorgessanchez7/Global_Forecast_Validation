...
#emails = ["allyblackhurst@gmail.com", "haidee.armstrong@gmail.com", "mark.payne749@gmail.com"]

emails = ["mishellpichardo@gmail.com"]
...
for uid in uids:
    ...
    url = "https://enee-hydroserver.geoglows.org/api/data/things/{}/ownership".format(uid)
