...
dischargeData = pd.read_csv('/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/row_data/NIVEL-DHIME.csv', index_col=9)
...
for id in IDs:
	...
	data = pd.read_csv("/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/row_data/rec_1/hourly/{0}_real_time_observed_wl.csv".format(id), index_col=0)
	...
	daily_df.to_csv("/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/row_data/rec_1/daily/{0}_real_time_observed_wl.csv".format(id), index_label="Datetime")
