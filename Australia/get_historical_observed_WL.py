...
for id, code, name, comid in zip(IDs, CODEs, Names, COMIDs):
	...
	if f.status_code == 200:
		...
		df1 = pd.DataFrame(pairs, columns=['Datetime', 'Water Level (m)'])
		...
		df3.to_csv('/Volumes/GoogleDrive/My Drive/PhD (1)/2022_Winter/Dissertation_v13/Australia/Australia/data/historical/Observed_Data_WL/{}.csv'.format(code))