...
for id, code, name, comid in zip(IDs, CODEs, Names, COMIDs):
	...
	#Observed Data
	df = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Australia/Australia/data/historical/Observed_Data/{}.csv'.format(code), index_col=0)
	df[df < 0] = 0
	...
	corrected_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Australia/Australia/data/historical/Corrected_Data/{0}-{1}.csv'.format(code, comid))