...
#df = pd.read_csv(r'/Users/student/Dropbox/PhD/2019 Fall/Dissertation_v8/Australasia/Australia_Stations.csv')
df = pd.read_csv('/Users/student/Github/Bias_Correction/Australia/Australia_Stations.csv')
...
for id, comid, name in zip(IDs, COMIDs, Names):
	obsFiles.append('/Users/student/Github/Bias_Correction/Australia/Observed/{}.csv'.format(id))
	#simFiles.append('/Users/student/Github/Bias_Correction/Australia/Simulated/{}.csv'.format(id))
	#simFiles.append('/Users/student/Github/Bias_Correction/Australia/Corrected/{}.csv'.format(id))
	#simFiles.append('/Users/student/Github/Bias_Correction/Australia/Corrected_2/{}.csv'.format(id))
	simFiles.append('/Users/student/Github/Bias_Correction/Australia/Corrected_3/{}.csv'.format(id))


#User Input
country = 'Australia'
#output_dir = '/Users/student/Github/Bias_Correction/Australia/validationResults_Original/'
#output_dir = '/Users/student/Github/Bias_Correction/Australia/validationResults_Corrected/'
#output_dir = '/Users/student/Github/Bias_Correction/Australia/validationResults_Corrected_2/'
output_dir = '/Users/student/Github/Bias_Correction/Australia/validationResults_Corrected_3/'
