...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Australia/Australia/Selected_Stations_Australia_WL.csv')
...
for id, code, name, comid in zip(IDs, CODEs, Names, COMIDs):
	...
	#Observed Data
	df = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Australia/Australia/data/historical/Observed_Data_WL/{}.csv'.format(code), index_col=0)
	...
	#Simulated Data
	simulated_df = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Australia/Australia/data/historical/Simulated_Data_WL/{}.csv'.format(comid), index_col=0)
	...
	corrected_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Australia/Australia/data/historical/Corrected_Data_WL/{0}-{1}.csv'.format(code, comid))