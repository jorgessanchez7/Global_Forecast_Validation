...
for id, code, name, comid in zip(IDs, CODEs, Names, COMIDs):
	...
	simulated_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD (1)/2022_Winter/Dissertation_v13/Australia/Australia/data/historical/Simulated_Data_WL/{}.csv'.format(comid))