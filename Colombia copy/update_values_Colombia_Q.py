...
for id, name, river in zip(IDs, Names, Rivers):
	...
	data_historic = pd.read_csv('/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/row_data/his/{}_historic_observed.csv'.format(id), index_col=0)

	datesHistoric = data_historic.index.tolist()
	valuesHistoric = data_historic.iloc[:, 0].values
	valuesHistoric.tolist()

	data_rec1 = pd.read_csv('/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/row_data/rec_1/daily/{0}_real_time_observed.csv'.format(id), index_col=0)
	...
	data_rec2 = pd.read_csv('/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/row_data/rec_2/daily/{0}_real_time_observed.csv'.format(id), index_col=0)
	...
	pd.DataFrame(pairs, columns=['Datetime', 'Streamflow (m3/s)']).to_csv(
		'/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/Historical/Observed_Data/Streamflow/{0}.csv'.format(
			id), encoding='utf-8', header=True, index=0)

	pd.DataFrame(pairs, columns=['Datetime', 'Streamflow (m3/s)']).to_csv(
		'/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/Forecast/Observed_Data/Streamflow/{0}.csv'.format(
			id), encoding='utf-8', header=True, index=0)