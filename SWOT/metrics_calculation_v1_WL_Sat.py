...
for id, comid, comid2 in zip(IDs, COMIDs, COMID2s):
    ...
    try:
        ...
        # Corrected Data
        corrected_df = pd.read_csv('E:\\GEOGloWS\\03_Transformed_Data\\swot_v1\\{0}-{1}_WL.csv'.format(id, comid), index_col=0)
...
all_metrics.to_csv('E:\\GEOGloWS\\Error_Metrics\\Metrics\\Metrics_GEOGloWS_v1_WL_SWOT.csv')