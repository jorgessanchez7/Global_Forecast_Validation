...
for comid, name in zip(COMIDs, Names):
	obsFiles.append(
		'/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/Historical/Simulated_Data/ERA_5/Daily/'
		+ str(comid) + '_' + str(name) + '.csv')
	#simFiles.append(
	#	'/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/Historical/Simulated_Data/ERA_5/Daily2/'
	#	+ str(comid) + '_' + str(name) + '.csv')
	simFiles.append(
		'/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/Historical/Simulated_Data/ERA_5/Daily3/'
		+ str(comid) + '_' + str(name) + '.csv')

#User Input
catchment = 'Magdalena'
output_dir = '/Users/student/Dropbox/PhD/2020 Winter/Dissertation_v9/South_America/Colombia/Historical/Simulated_Data/ERA_5/validationResults_2/'
