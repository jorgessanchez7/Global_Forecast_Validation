...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/Bhutan/Selected_Stations_Bhutan_Q_v0.csv')

IDs = stations_pd['comid'].tolist()
COMIDs = stations_pd['new_COMID'].tolist()
Names = stations_pd['HydroStation'].tolist()
...
for id, name, comid in zip(IDs, Names, COMIDs):
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/Bhutan/data/historical/Observed_Data/{}.csv'.format(id))
	#simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/Bhutan/data/historical/Simulated_Data/{}.csv'.format(comid))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/Bhutan/data/historical/Corrected_Data/{0}-{1}.csv'.format(id, comid))


#User Input
country = 'Bhutan'
#output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/Bhutan/data/historical/validationResults_Original/'
output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/Bhutan/data/historical/validationResults_Corrected/'
