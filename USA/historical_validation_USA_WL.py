...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/North_America/USA/Selected_Stations_USA_WL_v2.csv')
...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/North_America/USA/data/historical/Observed_Data_WL/{}.csv'.format(station_id))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/North_America/USA/data/historical/Corrected_Data_WL/{0}-{1}.csv'.format(station_id, comid))


#User Input
country = 'USA'
output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/North_America/USA/data/historical/validationResults_WL/'
