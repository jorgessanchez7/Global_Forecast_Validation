...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/Selected_Stations_SERVIR_Mekong_WL_v0.csv')
...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	simulated_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/data/historical/Simulated_Data_WL/{}.csv'.format(comid))