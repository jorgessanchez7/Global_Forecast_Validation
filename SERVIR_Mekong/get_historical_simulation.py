...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	simulated_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/data/historical/Simulated_Data/{}.csv'.format(comid))