...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/Selected_Stations_SERVIR_Mekong_Q_v0.csv')

IDs = stations_pd['StnID'].tolist()
COMIDs = stations_pd['new_COMID'].tolist()
Names = stations_pd['StnName'].tolist()
...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/data/historical/Observed_Data/{}.csv'.format(id))
	#simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/data/historical/Simulated_Data/{}.csv'.format(comid))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/data/historical/Corrected_Data/{0}-{1}.csv'.format(id, comid))


#User Input
country = 'SERVIR_Mekong'
#output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/data/historical/validationResults_Original/'
output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_Asia/SERVIR_Mekong/data/historical/validationResults_Corrected/'
