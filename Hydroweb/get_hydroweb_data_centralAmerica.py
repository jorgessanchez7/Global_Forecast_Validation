...
stations_pd = pd.read_csv('/Users/grad/Library/CloudStorage/Box-Box/Post_Doc/GEOGLOWS_Applications/Central_America/Central_America_Satellite_Stations.csv', index_col=0)
...
for name, latitude, longitude, type, code in zip(names, latitudes, longitudes, types, codes):
    ...
    try:
        ...
        observed_satellite_wl.to_csv('/Users/grad/Library/CloudStorage/Box-Box/Post_Doc/GEOGLOWS_Applications/Central_America/Observed_Data/Hydroweb/{}_WL.csv'.format(code))
    except Exception as e:
        print(e)