...
#axs[1, 0].set_ylim(173, 178)  #Station 1  # Set y-limit for the upper left plot
...
#axs[1, 1].set_ylim(173, 178)  #Station 1  # Set y-limit for the upper left plot
...
#Station 1
#point1_x = simulated_july_2["plot_index"][64]  #point in upper left plot
#point1_y = simulated_july_2['{}'.format(retro_input)][64]  #point in upper left plot
#point2_x = f_sim(point1_y)  #point in upper right plot
#point2_y = simulated_july_2['{}'.format(retro_input)][64]  #point in upper right plot
#point3_x = point2_x  #point in lower right plot
#point3_y = ((f_obs_inv(point2_x))+(corrected_july_2['Transformed Water Level (m)'][64])) / 2
#point4_x = simulated_july_2["plot_index"][64]  #point in lower left plot
