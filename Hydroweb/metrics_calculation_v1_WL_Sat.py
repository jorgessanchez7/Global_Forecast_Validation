...
for id, name, comid, comid2, latitude, longitude in zip(IDs, Names, COMIDs, COMID2s, Latitudes, Longitudes):
    ...
    try:
        ...
        # Corrected Data
        corrected_df = pd.read_csv('E:\\GEOGloWS\\03_Transformed_Data\\hydroweb_v1\\{0}-{1}_WL.csv'.format(id, comid), index_col=0)
...
all_metrics.to_csv('E:\\GEOGloWS\\Error_Metrics\\Metrics\\Metrics_GEOGloWS_v1_WL_Sat.csv')