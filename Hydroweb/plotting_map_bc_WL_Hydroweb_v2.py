...
stations_df = pd.read_csv('E:\\GEOGloWS\\Error_Metrics\\Metrics\\Metrics_GEOGloWS_v2_WL_Sat.csv')
...
buffer = 1.0  # buffer in degrees, adjust as necessary
...
plt.savefig('E:\\GEOGloWS\\Error_Metrics\\Maps\\Metrics_GEOGloWS_v2_WL_Sat.png', dpi=400, bbox_inches='tight', pad_inches=0)
plt.savefig('E:\\GEOGloWS\\Error_Metrics\\Maps\\Metrics_GEOGloWS_v2_WL_Sat.pdf', format='pdf', dpi=400, bbox_inches='tight', pad_inches=0)
#plt.show()