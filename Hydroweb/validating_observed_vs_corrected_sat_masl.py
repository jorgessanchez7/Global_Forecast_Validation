...
for element in list:
    ...
    for id, comid, name, station, country, region in zip(IDs, COMIDs, Names, stations, Countries, Regions):
        ...
        # Merging the Data
        merged_df = hd.merge_data(obs_df=observed_wl, sim_df=corrected_sat_wl)
    ...
    all_station_table.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Hydroweb/data/Common_Places/validationResults/observed_corrected_sat/Metrics_observed_corrected_sat_{0}.csv'.format(element))
