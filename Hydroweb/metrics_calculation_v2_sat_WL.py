...
for code, name, comid, latitude, longitude, basin, river, region, vpu in zip(Codes, Names, COMIDs, Latitudes, Longitudes, Basins, Rivers, Regions, VPUs):
    ...
    try:
        ...
        # Corrected Data
        corrected_df = pd.read_csv('/Users/grad/Library/CloudStorage/GoogleDrive-jsanchez@aquaveo.com/My Drive/Personal_Files/Post_Doc/Hydroweb/DWLT/GEOGLOWS_v2/{0}-{1}_WL.csv'.format(code, comid), index_col=0)
...
all_metrics.to_csv('/Users/grad/Library/CloudStorage/GoogleDrive-jsanchez@aquaveo.com/My Drive/Personal_Files/Post_Doc/Hydroweb/Metrics_GEOGloWS_v2_sat_WL.csv', index=False)