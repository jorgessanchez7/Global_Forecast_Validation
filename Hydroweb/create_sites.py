...
stations_df = pd.read_csv("/Users/grad/Library/CloudStorage/Box-Box/Post_Doc/Hydroweb/Total_Rivers_Stations_Hydroweb_Hydroserver_v2.csv", keep_default_na=False)
