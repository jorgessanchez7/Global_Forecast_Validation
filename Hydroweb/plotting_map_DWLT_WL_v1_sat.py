...
stations_df = pd.read_csv('/Users/grad/Library/CloudStorage/GoogleDrive-jsanchez@aquaveo.com/My Drive/Personal_Files/Post_Doc/Hydroweb/Metrics_GEOGloWS_v1_sat_WL.csv')
...
#plt.savefig('/Users/grad/Library/CloudStorage/GoogleDrive-jsanchez@aquaveo.com/My Drive/Personal_Files/Post_Doc/Hydroweb/Plots/Metrics_DWLT_GEOGLOWS_v1_sat_WL.png', dpi=400, bbox_inches='tight', pad_inches=0)
plt.savefig('/Users/grad/Library/CloudStorage/GoogleDrive-jsanchez@aquaveo.com/My Drive/Personal_Files/Post_Doc/Hydroweb/Plots/Metrics_DWLT_GEOGLOWS_v1_sat_WL.pdf', format='pdf', dpi=400, bbox_inches='tight', pad_inches=0)
#plt.show()