...
stations_pd = pd.read_csv('/Volumes/Macintosh HD/Users/grad/Google Drive/My Drive/PhD/2022_Winter/Dissertation_v13/Hydroweb/Hydroweb_v1.csv')
...
for name, comid in zip(Names, COMIDs):
	...
	fechas = []
	for fecha in dates:
		fechas.append(datetime.fromisoformat(fecha))
	...
	mean_wl.to_csv('/Volumes/Macintosh HD/Users/grad/Google Drive/My Drive/PhD/2022_Winter/Dissertation_v13/Hydroweb/data/Observed_Data/mean/{}_mean.csv'.format(name))
	...
	min_wl.to_csv('/Volumes/Macintosh HD/Users/grad/Google Drive/My Drive/PhD/2022_Winter/Dissertation_v13/Hydroweb/data/Observed_Data/min/{}_min.csv'.format(name))
	...
	max_wl.to_csv('/Volumes/Macintosh HD/Users/grad/Google Drive/My Drive/PhD/2022_Winter/Dissertation_v13/Hydroweb/data/Observed_Data/max/{}_max.csv'.format(name))
