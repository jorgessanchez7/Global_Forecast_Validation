...
for id, name, comid, comid2, latitude, longitude in zip(IDs, Names, COMIDs, COMID2s, Latitudes, Longitudes):

    print(id, ' - ', name, ' - ', comid, ' - ', comid2, ' - WL')
    ...
    try:
        ...
        # Corrected Data
        corrected_df = pd.read_csv('E:\\GEOGloWS\\03_Transformed_Data\\hydroweb_v2\\{0}-{1}_WL.csv'.format(id, comid2), index_col=0)
...
all_metrics.to_csv('E:\\GEOGloWS\\Error_Metrics\\Metrics\\Metrics_GEOGloWS_v2_WL_Sat.csv')