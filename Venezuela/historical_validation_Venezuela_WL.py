...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Venezuela/Selected_Stations_Venezuela_WL_v3.csv')
...
for id, name, comid in zip(IDs, Names, COMIDs):
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Venezuela/data/historical/Observed_Data_WL/{}.csv'.format(id))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Venezuela/data/historical/Corrected_Data_WL/{0}-{1}.csv'.format(id, comid))


#User Input
country = 'Venezuela'
output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Venezuela/data/historical/validationResults_WL/'
