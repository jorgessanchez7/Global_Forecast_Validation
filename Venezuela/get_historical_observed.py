...
df = pd.read_csv(r'/Volumes/GoogleDrive/My Drive/PhD/2020_Winter/Dissertation_v9/South_America/Venezuela/GASTOS.csv',encoding='unicode_escape')
...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	df3.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Venezuela/data/historical/Observed_Data/{}.csv'.format(id))