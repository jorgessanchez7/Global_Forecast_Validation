...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Africa/GRDC/Selected_Stations_GRDC_Africa_v2.csv')
...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Africa/GRDC/data/historical/Observed_Data/{}.csv'.format(id))
	#simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Africa/GRDC/data/historical/Simulated_Data/{}.csv'.format(comid))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Africa/GRDC/data/historical/Corrected_Data/{0}-{1}.csv'.format(id, comid))


#User Input
country = 'Africa'
#output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Africa/GRDC/data/historical/validationResults_Original/'
output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Africa/GRDC/data/historical/validationResults_Corrected/'
