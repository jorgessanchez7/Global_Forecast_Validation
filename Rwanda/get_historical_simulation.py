...
stations_pd = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Africa/Rwanda/Selected_Stations_Rwanda_Q_v0.csv')
...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	simulated_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Africa/Rwanda/data/historical/Simulated_Data/{}.csv'.format(comid))