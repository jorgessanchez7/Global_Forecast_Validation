...
for id, name, comid in zip(IDs, Names, COMIDs):
	obsFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Central_America/Dominican_Republic/data/historical/Observed_Data_WL/{}.csv'.format(id))
	simFiles.append('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Central_America/Dominican_Republic/data/historical/Corrected_Data_WL/{0}-{1}.csv'.format(id, comid))


#User Input
country = 'Dominican_Republic'
output_dir = '/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/Central_America/Dominican_Republic/data/historical/validationResults_WL/'
