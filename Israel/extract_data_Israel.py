...
if __name__ == "__main__":
    #path_to_files = r"/Volumes/storage/ECMWF_Gridded_Runoff_Files/output_compressed/middle_east-geoglows/"
    path_to_files = r"/Users/ElkiGio/Desktop/input/middle_east-geoglows/"

    df = pd.read_csv(r'/Users/ElkiGio/Desktop/Israel_Selected_Stations.csv')

    IDs = df['statid'].tolist()
    COMIDs = df['COMID'].tolist()
    Names = df['Name'].tolist()

    '''On Mac'''
    for name, spt, comid in zip(Names, IDs, COMIDs):
        if not os.path.isdir("/Users/ElkiGio/Desktop/output/Middle_East/Israel/{0}".format(comid)):
            os.makedirs("/Users/ElkiGio/Desktop/output/Middle_East/Israel/{0}".format(comid))
        output_path = "/Users/ElkiGio/Desktop/output/Middle_East/Israel/{0}".format(comid)
