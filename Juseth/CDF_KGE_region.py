...
regions = ['africa-geoglows', 'australia-geoglows', 'central_america-geoglows', 'central_asia-geoglows', 'east_asia-geoglows', 'europe-geoglows',
           'islands-geoglows', 'japan-geoglows', 'middle_east-geoglows', 'north_america-geoglows', 'south_america-geoglows', 'south_asia-geoglows',
           'west_asia-geoglows']
...
for region in regions:
    ...
    # ARCHIVOS DE ENTRADA
    # -----------------------------
    path_v1      =  "E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\Error_Metrics\\{0}\\Metrics_GEOGloWS_v1_Q.csv".format(region)
    path_rbc     =  "E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\Error_Metrics\\{0}\\Metrics_GEOGloWS_v1_RBC_Q.csv".format(region)
    path_mfdcqm  =  "E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\Error_Metrics\\{0}\\Metrics_GEOGloWS_v1_MFDC-QM_Q.csv".format(region)
    ...
    # -----------------------------
    plt.tight_layout()
    plt.savefig("E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\Maps\\{0}\\CDF_KGE_GEOGLOWS_v1_{0}.png".format(region), dpi=400)
    plt.show()
