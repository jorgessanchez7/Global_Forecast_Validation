...
output_folder = "C:\\Users\\jsanchez\\Downloads\\profesor_Alvaro\\Simulated_Data\\GEOGLOWS_v1"
...
for id, comid in zip(IDs, COMIDs):
	...
	#Simulated Data
	simulated_df = pd.read_csv('C:\\Users\\jsanchez\\Downloads\\profesor_Alvaro\\Simulated_Data\\GEOGLOWS_v1\\{}.csv'.format(id), index_col=0)
	...
	corrected_df.to_csv('C:\\Users\\jsanchez\\Downloads\\profesor_Alvaro\\Simulated_Data\\GEOGLOWS_v1\\{}_bc.csv'.format(id))