...
stations_pd = stations_pd[stations_pd['region'] == 'south_america']
...
output_folder = "E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\Historical_Simulation_bc"

for id, name, comid, folder, source in zip(IDs, Names, COMIDs, Folders, Sources):

    print(id, ' - ', name, ' - ', comid, ' - Q')

    file_path = f"{output_folder}\\{comid}_bc.csv"
    ...
    qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\south_america-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\north_america-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\europe-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\central_america-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\africa-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\australia-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\islands-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\japan-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\central_asia-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\east_asia-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\south_asia-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\middle_east-geoglows\\Qout_geoglows_v1_bc.nc')
    #qout_nc = nc.Dataset('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\netcdf_files\\west_asia-geoglows\\Qout_geoglows_v1_bc.nc')
    ...
    simulated_df.to_csv('E:\\Post_Doc\\GEOGLOWS_Applications\\Runoff_Bias_Correction\\GEOGLOWS_v1\\Historical_Simulation_bc\\{}_bc.csv'.format(comid))
