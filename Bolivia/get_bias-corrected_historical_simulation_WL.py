...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	#Observed Data
	df = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Bolivia/data/historical/Observed_Data_WL/{}.csv'.format(id), index_col=0)
	...
	#Simulated Data
	simulated_df = pd.read_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Bolivia/data/historical/Simulated_Data_WL/{}.csv'.format(comid), index_col=0)
	...
	corrected_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Bolivia/data/historical/Corrected_Data_WL/{0}-{1}.csv'.format(id, comid))