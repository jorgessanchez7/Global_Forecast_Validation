...
if __name__ == "__main__":
    ...
    df = pd.read_csv(r'/Users/student/Dropbox/PhD/2019 Fall/Dissertation_v8/South_Asia/Bangladesh/Bangladesh_Selected_Stations.csv')
    ...
    for name, spt, comid in zip(names, spt_id, stations):
        if not os.path.isdir("/Users/student/Desktop/output/South_Asia/Bangladesh/{0}-{1}".format(spt, name)):
            os.makedirs("/Users/student/Desktop/output/South_Asia/Bangladesh/{0}-{1}".format(spt, name))
        output_path = "/Users/student/Desktop/output/South_Asia/Bangladesh/{0}-{1}".format(spt, name)
