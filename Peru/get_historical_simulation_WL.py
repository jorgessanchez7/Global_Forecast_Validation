...
for id, name, comid in zip(IDs, Names, COMIDs):
	...
	simulated_df.to_csv('/Volumes/GoogleDrive/My Drive/PhD/2022_Winter/Dissertation_v13/South_America/Peru/data/historical/Simulated_Data_WL/{}.csv'.format(comid))